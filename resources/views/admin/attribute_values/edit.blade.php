    ...
    <section class="section">
        <div class="container-fluid">
            ...
            <div class="form-elements-wrapper">
                <div class="row">
                    <form method="POST" action="{{ route('admin.attributeValues.update', [$attributeValue->id, $attributeId]) }}">
                        @csrf
                        @method('PUT') <!-- Chỉ ra rằng đây là một yêu cầu PUT -->
                        <div class="col-lg-12">
                            ...
                            <div class="card-style">
                                <div class="input-style-1">
                                    ...
                                    <input type="text" placeholder="Attribute Value Name" name="name"
                                        value="{{ old('name', $attributeValue->name) }}" required />
                                    @error('name')
                                ...
                                <div class="input-style-1">
                                    <label>Stock</label>
                                    <input type="number" placeholder="Stock" name="stock" value="{{ old('stock', $attributeValue->stock) }}"
                                        required />
                                    @error('stock')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="input-style-1">
                                    ...
                                    <input type="number" placeholder="Price In" name="priceIn"
                                        value="{{ old('priceIn', $attributeValue->priceIn) }}" required />
                                    @error('priceIn')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="input-style-1">
                                    ...
                                    <input type="number" placeholder="Price Out" name="priceOut"
                                        value="{{ old('priceOut', $attributeValue->priceOut) }}" required />
                                    @error('priceOut')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
